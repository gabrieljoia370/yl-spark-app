...
Return JSON with this exact shape:
{
  ...
  "visualSupports": {
    "boardPicture": "A simple picture the teacher can draw on the board for this lesson, described clearly.",
    "printableFlashcards": [
      { "label": "word or phrase", "imageIdea": "simple child-friendly image to show this word" }
    ],
    "picturePrompts": [
      "A safe, child-friendly image prompt a teacher can paste into an image generator or Canva AI",
      "Another useful visual prompt"
    ],
    "noPrepVisuals": [
      "Visual/realia option using objects, gestures, board drawings or classroom items"
    ]
  },
  "stages": [
    {
...
IMPORTANT: Because this is for young learners, always include visualSupports. The visuals must be concrete, classroom-friendly and directly connected to the topic and target language. Do not invent copyrighted characters. Avoid brand names. Picture prompts should be safe for children and suitable for classroom materials.`,
